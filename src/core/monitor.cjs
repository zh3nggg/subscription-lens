...
class Monitor{
 ...
 const groups=new Map(),modelGroups=new Map(),days=new Map();let tokens=0,input=0,cached=0,output=0,estimated=0n,reported=0n,estimatedRecords=0,reportedRecords=0,unpriced=0,knownStatus=0,failed=0;const latency=[],ttft=[];
