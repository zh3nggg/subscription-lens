...
class Account{
  ...
  async start(generation){
    ...
    const init=await this.call('initialize',{clientInfo:{name:'subscription_lens',title:'Subscription Lens',version:'1.4.0-beta.6'},capabilities:{experimentalApi:true}});
