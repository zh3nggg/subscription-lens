...
class Account{
  ...
  async start(generation){
    ...
    const init=await this.call('initialize',{clientInfo:{name:'subscription_lens',title:'Subscription Lens',version:'1.3.0-beta.1'},capabilities:{experimentalApi:true}});
