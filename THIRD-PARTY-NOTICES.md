...
This source is included for the next accounting-engine integration. Version 1.4.0-beta.6 does not execute or bundle the experimental native binary. Passing upstream tests does not establish desktop feature parity.
