...
if(next.stable)next.fallback=null;
...
next.policy='Latest verified stable and preview; previous preview as fallback until the first stable release.';next.updatedAt=new Date().toISOString();next.note=next.stable?'Stable and preview slots retained.':'No formally stable release exists; the previous preview remains the rollback copy.';
